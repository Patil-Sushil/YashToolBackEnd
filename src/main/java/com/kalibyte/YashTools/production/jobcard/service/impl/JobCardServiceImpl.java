...
public class JobCardServiceImpl implements JobCardService {
    ...
    private JobCardResponse toResponse(JobCard jc) {
        return JobCardResponse.builder()
                ...
                .workOrderItemId(jc.getWorkOrderItem().getId())
                .lineNumber(jc.getWorkOrderItem().getLineNumber())
                .toolName(jc.getWorkOrderItem().getToolName())
                .itemName(jc.getWorkOrderItem().getItemName())
